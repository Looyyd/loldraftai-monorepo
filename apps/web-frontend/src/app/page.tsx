...
export default function HomePage() {
  return (
    <main className="flex min-h-screen w-full flex-col items-center bg-background text-foreground">
      {/* Hero Section */}
      <div className="w-full bg-gradient-to-b from-primary/10 to-background py-10">
        <div className="container flex flex-col items-center justify-center gap-6 px-4">
          ...
          <p className="max-w-2xl text-xl text-center text-muted-foreground">
            ...
            <SparklesIcon className="inline-block h-5 w-5 " />
          </p>
        </div>
      </div>

      {/* Main Content */}
      <div className="container flex flex-col items-center justify-center px-4 py-16 space-y-24">
        ...
        <section className="flex flex-col items-center max-w-4xl">
          <h2 className="text-3xl font-bold mb-6">Desktop version</h2>
          <p className="text-lg text-center">
